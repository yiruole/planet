...
| 改动 | 效果 |
|---|---|
| 摄像机绕 CLK_C 公转（半径 6.9）| 镜头不停旋转，音乐响→加速 |
| Mie 前向散射 g1=0.84 | 云边缘银白边光（写实天空效果）|
| rimS 散射项 | 靠近太阳方向的云轮廓发亮 |
| 云顶暖色 / 云底冷蓝 | 立体感更强 |
| 地平线暖带 + 更大日晕 | 天空层次更丰富 |

**导出：** `TDcloud_final_30s.mp4`（ffmpeg 合并音视频）
**作品名：**《云计》— Pink Floyd The Great Gig in the Sky
...
- [ ] v9 视觉确认：旋转速度是否合适（调 `uTime * 0.14`）
- [ ] 云层写实度是否满意（银边、层叠效果）
- [ ] 如需要：进一步提升写实感（Worley noise / 3D时钟体）
- [x] 录制最终版本视频 — `TDcloud_final_30s.mp4`
